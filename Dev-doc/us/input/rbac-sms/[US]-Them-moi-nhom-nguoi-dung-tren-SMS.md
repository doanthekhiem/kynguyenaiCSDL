...
|  |  | A |  |  |
|  | <https://mfacilities.atlassian.net/wiki/spaces/EES/pages/946208773/US+Th%C3%AAm+m%E1%BB%9Bi+nh%C3%B4m+ng%C6%B0%E1%BB%9Di+d%C6%B0ng+tr%C3%AAn+SMS#AC-3%3A-Th%C3%AAm-m%E1%BB%9Bi-nh%C3%B3m-ng%C6%B0%E1%BB%9Di-d%C3%B9ng-th%C3%A0nh-c%C3%B4ng> | M | * Bổ sung thêm thông tin khi tạo mới, cho phép chọn người dùng ngay khi thêm mới nhóm | 14 |
| 14/11/2025 |  | M | * AC-3:    + Danh sách người dùng để thêm mới chỉ hiển thị người dùng ở trạng thái Đang hoạt động   + Bổ sung thêm trường "Vai trò" để gán khi thêm mới nhóm * Gạch bỏ AC-9, AC-11 | 18 |
|  |  | M | * AC-3: Chỉnh sửa lại điều kiện bắt buộc cho trường "Vai trò" khi tạo mới | 23 |
...
### AC-1: Truy cập màn hình thêm mới nhóm người dùng

Tại màn hình danh sách nhóm người dùng thuộc phân hệ Quản lý nhóm người dùng

Khi nhóm người dùng bấm nút "Thêm mới nhóm người dùng"

Thì hệ thống điều hướng sang màn hình Thêm mới nhóm người dùng và cho phép người dùng nhập liệu

### AC-2: Không có quyền thêm mới nhóm người dùng

Tại màn hình danh sách nhóm người dùng thuộc phân hệ Quản lý nhóm người dùng

Khi không có quyền thêm mới nhóm người dùng

Thì hệ thống:

* Disable nút "Thêm mới nhóm người dùng"
...
### AC-3: Thêm mới nhóm người dùng thành công
...
* Lưu thông tin thêm mới nhóm người dùng
* Đặt trạng thái nhóm người dùng = Đang hoạt động (Active)
* Quay lại màn hình danh sách nhóm người dùng và cập nhật lại dữ liệu màn hình danh sách nhóm người dùng
...
| 2 | Mã nhóm người dùng | Có | * Mã code của nhóm người dùng mới * Không hiển thị trên màn hình thêm mới * Sinh khi lưu thành công * Rule 019 <https://mfacilities.atlassian.net/wiki/spaces/EES/pages/886636583/System+Rules+-+Business+rules#SYS-RULE-019> |  |  |  |
| 3 | Tên nhóm người dùng | Có | * Nhập tên nhóm người dùng * Nhập freetext * Cho phép nhập ký tự là chữ cái, chữ số, ký tự đặc biệt và khoảng trắng. * Quy định độ dài: 255 ký tự |  |  |  |
...
| 5 | Vai trò | Có | * Dropdown chọn nhiều giá trị * Danh sách giá trị: Hiển thị danh sách các vai trò có trạng thái "Đang hoạt động" cho người dùng chọn vai trò gán cho nhóm |  |  |  |
| 6 | **Danh sách người dùng**   * Không bắt buộc * Hiển thị danh sách người dùng ở trạng thái "Đang hoạt động", ~~"Không hoạt động"~~ | | |  |  |  |
| 7 | Thanh tìm kiếm | N/A | * Nhập freetext * Placeholder "Tìm kiếm" * Quy định độ dài: 50 ký tự * Cho phép nhập ký tự là chữ cái, số, ký tự đặc biệt và khoảng trắng * Cho phép tìm kiếm theo: Email, Tên người dùng |  |  |  |
| 8 | Lọc theo ngày tạo | N/A | * Date range picker * Placeholder "Chọn khoảng ngày tạo" * Chọn khoảng thời gian để lọc theo {Ngày tạo} * Người dùng có thể chọn ngày bắt đầu và ngày kết thúc * Ngày kết thúc >= Ngày bắt đầu * Format ngày: `dd/mm/yyyy`. * Cho phép clear để bỏ lọc. |  |  |  |
| 9 | ~~Lọc theo trạng thái~~ | ~~N/A~~ | * ~~Chọn 1 giá trị~~ * ~~Mặc định: Tất cả trạng thái~~ * ~~Danh sách giá trị:~~    + ~~Đang hoạt động~~   + ~~Không hoạt động~~ |  |  |  |
| 10 | Checkbox | Có | * Cho phép chọn nhiều người dùng cùng 1 lúc * Default: uncheck |  |  |  |
| 11 | Tên người dùng | N/A | * Hiển thị tên người dùng |  |  |  |
| 12 | Email | N/A | * Hiển thị email của người dùng |  |  |  |
| 13 | Số điện thoại | N/A | * Hiển thị số điện thoại của người dùng * Không có => hiển thị "--" |  |  |  |
| 14 | Trạng thái | N/A | * Hiển thị trạng thái của người dùng    + Đang hoạt động   + ~~Không hoạt động~~ |  |  |  |
| 15 | Ngày tạo | N/A | * Hiển thị thời điểm người dùng được tạo trên hệ thống * Format: dd/mm/yyyy |  |  |  |
| 16 |  |  |  |  |  |  |
| 17 | **~~Tab Cấu hình người dùng~~** | | |  |  |  |
| 18 | ~~Email~~ | ~~Có~~ | * ~~Type: Dropdown with search~~ * ~~Cho phép chọn và tìm kiếm email trong danh sách người dùng~~ * ~~Danh sách giá trị: hiển thị danh sách toàn bộ người dùng trong tổ chức nhà trường/ trung tâm~~ |  |  |  |
| 19 | ~~Tên người dùng~~ | ~~n/a~~ | * ~~Hiển thị theo Email~~ |  |  |  |
| 20 | ~~Thao tác Xóa~~ | ~~n/a~~ | * ~~type: button~~ * ~~Cho phép bấm để xóa 1 người dùng~~ * ~~Cho phép bấm để thêm người dùng vào trong danh sách~~ |  |  |  |
...
### AC-5: Hiển thị thông báo lỗi khi trường bắt buộc bị xóa và nhóm người dùng rời khỏi ô nhập liệu
...
### AC-13: Hủy bỏ thêm mới nhóm người dùng khi chưa nhập thông tin tạo mới
...
* Hủy bỏ thao tác thêm mới nhóm người dùng
* Không lưu bất kỳ thông tin gì trong form thêm mới nhóm người dùng
* Quay trở lại màn hình danh sách nhóm người dùng

### AC-14: Hủy bỏ thêm mới nhóm người dùng khi đã nhập thông tin tạo mới

Tại màn hình khai thêm mới nhóm người dùng

Khi bấm nút "Hủy" khi đã nhập ít nhất 1 thông tin thêm mới nhóm người dùng
...
* Khi nhóm người dùng bấm "Tiếp tục tạo mới"
  ...
  + Hệ thống sẽ:
    ...
    - Đóng popup
    - Giữ nguyên tại màn hình thêm mới nhóm người dùng
    - Giữ lại các thông tin thêm mới nhóm người dùng đã được nhập trước đó.

### AC-15: Thêm mới nhóm người dùng không thành công

Tại màn hình thêm mới nhóm người dùng

Khi nhóm người dùng bấm Lưu để thêm mới nhóm người dùng
