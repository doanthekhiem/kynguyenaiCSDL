...
**Là** Admin user của 1 tổ chức nhà trường/ trung tâm
...
**Khi** có quyền chỉnh sửa và nhấn vào nút "Chỉnh sửa" của một vai trò,
...
**Khi** xóa giá trị trường "Tên vai trò" và rời khỏi ô nhập liệu,
...
**Khi** nhập vượt quá giới hạn ký tự cho phép
...
**Khi** tick người dùng hoặc nhóm,

**Thì** hệ thống thêm đối tượng đó vào danh sách đối tượng.

### **AC-11: Giữ trạng thái tick khi chuyển trang hoặc chuyển tab**

**Tại** tab Người dùng hoặc Nhóm người dùng,

**Khi** tick Người dùng/ Nhóm rồi chuyển trang hoặc chuyển tab,

**Thì** khi quay lại trang cũ hoặc tab cũ, trạng thái tick vẫn được giữ nguyên.

### **AC-12: Giữ trạng thái khi rời tab "Cấu hình đối tượng"**

**Tại** màn hình chỉnh sửa vai trò,

**Khi** rời tab "Cấu hình đối tượng" sang tab khác,
...
**Khi** nhập tên hợp lệ, có ít nhất 1 quyền, có đối tượng, và có phạm vi dữ liệu,
...
**Khi** nhấn "Hủy" mà form chưa có thay đổi,
...
**Khi** nhấn "Hủy" và form đã có chỉnh sửa,
...
* Giúp cập nhật vai trò đúng theo thay đổi vận hành
...
### Link figma: <https://www.figma.com/design/2yGjjCTWWatN1iUGU1Wqfl/S.1-2-3---CFM-MVP1---Handoff?node-id=10321-223640&t=xTEYyWBk6PfdBWlA-4>
