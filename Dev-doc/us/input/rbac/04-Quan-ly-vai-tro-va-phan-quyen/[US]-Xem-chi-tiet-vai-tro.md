...
|  |  | A |  |  |
|  |  | M | * Bỏ các AC liên quan tới đối tác |  |
...
**Khi** Ops có quyền Xem chi tiết và nhấn "Xem chi tiết",
...
**Khi** Ops nhấn chuyển trạng thái "Không hoạt động",

**Thì** hệ thống hiển thị popup xác nhận: rule 029System Rules - Business rules
...
**Khi** Ops nhấn chuyển trạng thái "Đang hoạt động",
...
* Giúp Ops hiểu rõ vai trò đang tồn tại và phạm vi ảnh hưởng của nó
...
US Danh sách vai trò: <https://mfacilities.atlassian.net/wiki/spaces/EES/pages/971636760/US+Danh+s+ch+nh+m?atlOrigin=eyJpIjoiNjc1NjAwNTM2OGY2NGI5MWI1MDUwZTU0ODFhZDk3ZDIiLCJwIjoiYyJ9>

US Danh sách vai trò người dùng đối tác: <https://mfacilities.atlassian.net/wiki/spaces/EES/pages/954826788/US+Danh+s+ch+nh+m+ng+i+d+ng?atlOrigin=eyJpIjoiNTA3OWJlZDBlMzEzNDI3Yjg1NDYyZjhkYzg2YzUyODUiLCJwIjoiYyJ9>

US Gán người dùng vào trong vai trò đối tác: <https://mfacilities.atlassian.net/wiki/spaces/EES/pages/958758921/Sub-US+G+n+ng+i+d+ng+v+o+nh+m+t+i+tab+nh+m+ng+i+d+ng?atlOrigin=eyJpIjoiN2RiZWJjMmQ4MzNjNGMzNWI2OWQ1MDJhNWQ5Zjc5NjkiLCJwIjoiYyJ9>
...
Out of Scope Item
=================
# [US] Xem chi tiết vai trò

**Page ID:** 949977094  
**Confluence Link:** https://aeh.atlassian.net/spaces/EES/pages/949977094
