...
|  |  | M | * AC-3:    + Gạch bỏ 2 trường "Phạm vi áp dụng" và "Đối tượng áp dụng" |  |
...
**Khi** Ops nhập từ khóa vào ô "Tìm kiếm vai trò",
...
**Khi** Ops chọn trạng thái (Tất cả / Đang hoạt động / Không hoạt động),
...
**Khi** Ops nhấn "Xem chi tiết" tại một hàng vai trò,
...
**Khi** Ops có quyền Chỉnh sửa và nhấn "Chỉnh sửa",
...
**Khi** Ops vừa tìm kiếm, vừa lọc trạng thái, vừa phân trang,
...
* Giúp Ops quản lý toàn bộ vai trò dễ dàng
...
### Link figma: <https://www.figma.com/design/2yGjjCTWWatN1iUGU1Wqfl/S.1---CFM-MVP1---Handoff?node-id=8665-167653&t=MEnhtU3rT74kzcB2-4>

Out of Scope Item
=================
# [US] Danh sách vai trò

**Page ID:** 949977093  
**Confluence Link:** https://aeh.atlassian.net/spaces/EES/pages/949977093
