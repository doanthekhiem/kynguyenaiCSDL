# [US] Danh sách người dùng trên EOP

**Page ID:** 949977086
**Confluence Link:** https://aeh.atlassian.net/spaces/EES/pages/949977086
...
|  |  | A |  |  |
|  |  | M | * AC-3:    + Bổ sung bộ lọc theo nhóm, vai trò   + Bổ sung hiển thị thêm: Danh sách nhóm, danh sách vai trò | 5 |
|  |  |  |  |  |
...
Tôi muốn xem danh sách tất cả người dùng đã được tạo trong hệ thống nội bộ EOP
...
| 12 | Số lượng nhóm | * Hiển thị tổng số lượng nhóm mà người dùng đang thuộc về |  |
| 13 | Danh sách nhóm | * Hiển thị danh sách các nhóm mà người dùng đang được gán, ở trạng thái "Đang hoạt động" |  |
| 14 | Danh sách vai trò | * Hiển thị danh sách các vai trò được gán cho người dùng, ở trạng thái "Đang hoạt động" |  |
| 15 | Trạng thái | * Hiển thị trạng thái của người dùng    + Tạm ngưng   + Đang hoạt động   + Không hoạt động   + Bị khóa |  |
| 16 | Ngày tạo | * Hiển thị thời điểm người dùng được tạo trên hệ thống * Format: dd/mm/yyyy * Cho phép sort theo:    + ASC   + DESC |  |
| 17 | ~~Người tạo~~ | * ~~Hiển thị username của người tạo người dùng~~ |  |
| 18 | Dot icon | * Hiển thị các actions:    + Xem chi tiết   + ~~Chỉnh sửa~~   + Thêm vào nhóm   + Bỏ khỏi nhóm |  |
...
* Giúp Ops có cái nhìn toàn cảnh về đội ngũ người dùng đang hoạt động trong tổ chức nhà trường/ trung tâm
