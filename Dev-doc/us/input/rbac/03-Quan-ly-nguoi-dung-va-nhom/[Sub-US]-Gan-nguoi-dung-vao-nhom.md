# [Sub-US] Gán người dùng vào nhóm

**Page ID:** 996048901  
**Confluence Link:** https://aeh.atlassian.net/spaces/EES/pages/996048901
...
Tại màn hình Quản lý người dùng & nhóm, tab Danh sách nhóm
...
| 8 | Ngày tạo | * Hiển thị thời điểm người dùng được tạo trên hệ thống * Format: dd/mm/yyyy |
...
### AC-7: Xử lý trường hợp dữ liệu hiển thị cũ khi thêm người dùng vào nhóm
