...
export default function LoginPage() {
  ...
  const { signInWithEmail, signUpWithEmail, signInWithGoogle, signInWithGithub, user } = useAuth();
    ...
    <div className="min-h-screen flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="glass-surface rounded-2xl p-8 shadow-xl">
          <h1 className="text-2xl font-bold text-center mb-2">{isLogin ? "Đăng nhập" : "Đăng ký"}</h1>
          <p className="text-muted-foreground text-center mb-6">
            {isLogin ? "Chào mừng bạn trở lại!" : "Tạo tài khoản để trải nghiệm đầy đủ"}
          </p>
          ...
          <div className="flex gap-3 mb-6">
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-xl border border-surface-border hover:bg-surface-hover transition-colors"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl bg-surface border border-surface-border focus:border-[hsl(199,89%,48%)] focus:ring-1 focus:ring-[hsl(199,89%,48%)] outline-none transition-colors"
